...
const submitForm = async () => {
  ...
  try {
    // Замените это на вашу реальную логику входа
...
<template>
    <div class="relative flex flex-col justify-center min-h-screen overflow-hidden">
        <div class="w-4/5 lg:w-full p-6 m-auto bg-white rounded shadow-lg ring-2 ring-purple-800/50 lg:max-w-md">
            ...
            <p class="mt-8 text-xs font-light text-center text-gray-700"> Нет аккаунта?
                <router-link to="/signup" class="font-montserrat font-medium text-purple-600 hover:underline">
                    Регистрация
                </router-link>
            </p>
        </div>
