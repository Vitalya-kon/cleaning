      ...
      >
        <div class="shadow p-4 rounded-lg bg-white">
          ...
          <div class="mt-4">
            ...
            <p :data-tooltip-target="'tooltip-light_' + id" data-tooltip-placement="bottom" class="mt-2 font-montserrat text-sm text-gray-800 lg:line-clamp-3 whitespace-pre-line z-50">
              {{ description }}
            </p>
